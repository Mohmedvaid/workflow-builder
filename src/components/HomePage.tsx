...
export default function HomePage({ onCreateNew, onOpenWorkflow }: HomePageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50">
      ...
      {/* Header */}
      <header className="bg-white/80 backdrop-blur-sm border-b border-blue-200 shadow-sm sticky top-0 z-40">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-6">
        ...
        <div className="mb-6 flex items-center justify-between">
          <h2 className="text-2xl font-bold text-gray-900">
            Your Workflows <span className="text-blue-600">({workflows.length}/5)</span>
          </h2>
          {workflows.length >= 5 && (
            <div className="text-sm text-blue-700 bg-blue-50 px-4 py-2 rounded-lg border border-blue-200 font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {workflows.map((workflow) => (
            <div
              ...
              className="bg-white rounded-xl border-2 border-blue-100 p-6 hover:border-blue-300 hover:shadow-lg transition-all cursor-pointer group backdrop-blur-sm bg-white/90"
            >
